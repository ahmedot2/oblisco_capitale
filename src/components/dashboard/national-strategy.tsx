...
const propositions = [
  {
    ...
    visual: <div className="absolute inset-0 bg-[url('https://placehold.co/600x400/000000/000000')] bg-cover bg-center opacity-10" data-ai-hint="map qatar egypt"></div>
  },
  {
    ...
    visual: <div className="absolute inset-0 bg-[url('https://placehold.co/600x400/000000/000000')] bg-cover bg-center opacity-10" data-ai-hint="global trade"></div>
  },
  {
    ...
    visual: <div className="absolute inset-0 bg-[url('https://placehold.co/600x400/000000/000000')] bg-cover bg-center opacity-10" data-ai-hint="doha skyline"></div>
  }
];
